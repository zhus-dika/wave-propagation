package com.wavepropagation.webapp.repository;

import com.wavepropagation.webapp.WavepropagationApp;

import com.wavepropagation.webapp.config.Constants;
import com.wavepropagation.webapp.config.audit.AuditEventConverter;
import com.wavepropagation.webapp.domain.PersistentAuditEvent;
...
import static com.wavepropagation.webapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
